...
object LoudamService  {
  val TOPIC_NAME = "greetings"
}

/**
  * The loudam service interface.
  * <p>
  * This describes everything that Lagom needs to know about how to serve and
  * consume the LoudamService.
  */
trait LoudamService extends Service {
  ...
  override final def descriptor = {
    ...
    named("loudam")
      ...
      .withTopics(
        topic(LoudamService.TOPIC_NAME, greetingsTopic)
